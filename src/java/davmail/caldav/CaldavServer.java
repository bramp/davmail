...
public class CaldavServer extends AbstractServer {
     ...
     */
    public CaldavServer(int port, ExchangeSessionFactory sessionFactory) {
        super(CaldavServer.class.getName(), port, CaldavServer.DEFAULT_PORT, sessionFactory);
    ...
    public AbstractConnection createConnectionHandler(Socket clientSocket) {
        return new CaldavConnection(clientSocket, sessionFactory);
    }
}